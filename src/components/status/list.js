...
class status extends Component {
    ...
    componentDidMount() {
        ...
        function formDelete(id) {
            if (id >= 1) {
                ...
                fetch(Const.urlrest + "/api/status/destroy", {
        ...
        $(document).off().on('click', '.btnupdate', function () {
            ...
            if (name.length >= 4) {
                ...
                fetch(Const.urlrest + "/api/status/update", {
                        headers: Const.myHeaders,
                        method: "PUT",
                        body: JSON.stringify(datos)
                    })
    ...
    render() {
                ...
                function formEdit(id) {
                    ...
                    fetch(Const.urlrest + "/api/status/read", {
                            headers: Const.myHeaders,
                            method: "POST",
                            body: JSON.stringify({
                                id: id
                    ...
                    <div className="page-wrapper">
                        <div className="row page-titles">
                            <div className="col-md-12 align-self-center">
                                <h3 className="text-primary">Estados conceptos</h3> </div>
