...
class typetaxes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
            ...
            .then(
                ...
                $(document).off().on('click', '.btnupdate', function () {
                    ...
                    if (name.length >= 4) {
                        ...
                        fetch(Const.urlrest + "/api/typetaxes/update", {
                                headers: Const.myHeaders,
                                method: "PUT",
                ...
                function formDelete(id) {
                    if (id >= 1) {
                        ...
                        fetch(Const.urlrest + "/api/typetaxes/destroy", {
                                headers: Const.myHeaders,
                                method: "DELETE",
                                body: JSON.stringify(datos)
                            })
    ...
    render() {
            ...
            function formEdit(id) {
                ...
                fetch(Const.urlrest + "/api/typetaxes/read", {
                        headers: Const.myHeaders,
                        method: "POST",
                        body: JSON.stringify({
                            id: id
                    ...
                    <div className="page-wrapper">
                        <div className="row page-titles">
                            <div className="col-md-12 align-self-center">
                                <h3 className="text-primary">Tipo de Flete</h3> </div>
