...
class typeshipping extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
    ...
    componentDidMount() {
        ...
        function formDelete(id) {
            if (id >= 1) {
                ...
                fetch(Const.urlrest + "/api/typeshipping/destroy", {
        ...
        fetch(Const.urlrest + "/api/typeshipping",{
            headers: Const.myHeaders,
        })
            .then(response => response.json())
            .then(
            ...
            $(document).off().on('click', '.btnupdate', function () {
                ...
                if (name.length >= 4) {
                    ...
                    fetch(Const.urlrest + "/api/typeshipping/update", {
                        headers: Const.myHeaders,
                            method: "PUT",
                            body: JSON.stringify(datos)
                        })
    ...
    render() {
        ...
        function formEdit(id) {
           ...
           document.querySelector('.formupdate').style.display = 'block'
            fetch(Const.urlrest + "/api/typeshipping/read", {
                headers: Const.myHeaders,
                    method: "POST",
                    body: JSON.stringify({
                        id: id
                    ...
                    <div className="page-wrapper">
                        <div className="row page-titles">
                            <div className="col-md-12 align-self-center">
                                <h3 className="text-primary">Tipos de envío</h3> </div>
