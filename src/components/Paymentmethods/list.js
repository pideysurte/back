                ...
                btnAlertConfirm.addEventListener("click", formConfirmDelete);
                    ...
                    function formDelete(id) {
                        if (id >= 1) {
                            ...
                            fetch(Const.urlrest + "/api/paymentmethods/destroy", {
        ...
        fetch(Const.urlrest + "/api/paymentmethods", {
            ...
            $(document).off().on('click', '.btnupdate', function () {
                ...
                if (name.length >= 4) {
                    ...
                    fetch(Const.urlrest + "/api/paymentmethods/update", {
                        headers: Const.myHeaders,
                            method: "PUT",
                            body: JSON.stringify(datos)
                        })
    ...
    render() {
        ...
        function formEdit(id) {
           ...
           document.querySelector('.formupdate').style.display = 'block'
            fetch(Const.urlrest + "/api/paymentmethods/read", {
                    headers: Const.myHeaders,
                    method: "POST",
                    body: JSON.stringify({
                        id: id
                                    ...
                                    <div className="card">
                                        <div className="card-body">  
                                            ...
                                            <MaterialTable
                                                    title="Datos"
                                                    columns={[
                                                         { title: 'Id', field: 'id', type: 'html' },
                                                        { title: 'Nombre', field: 'name' , type: 'html'}
                                                    ]}
                                                    data = {
                                                        items
                                                    }
